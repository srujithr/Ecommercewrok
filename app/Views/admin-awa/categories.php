...
<?php if (session()->has('error')): ?>
    ...
    <!-- Your HTML form -->
    <form class="row g-3" action="<?= base_url('add-category') ?>" method="POST" enctype="multipart/form-data">
        <div class="col-12">
            <label class="form-label" for="category_name">Category Name</label>
            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Enter category name">
            <!-- Display error message for category name field -->
            <?php if (isset($validation) && $validation->hasError('category_name')): ?>
                <div class="text-danger"><?= $validation->getError('category_name') ?></div>
            <?php endif; ?>
        </div>
    ...
    <div class="form-check">
        <input class="form-check-input" type="checkbox" id="is_banner" name="is_banner">
        <label class="form-check-label" for="is_banner">
            Use as banner image
        </label>
    </div>
</div>
