...
<form class="row g-3" action="<?= base_url('add-sub-category') ?>" method="POST" enctype="multipart/form-data">
    <div class="col-12">
    ...
    <tr>
        ...
        <td>
            <a href="<?= base_url('SubcategoryEditView/' . $subcategory['sub_id']) ?>" title="Edit"><i class="bi bi-pencil-fill"></i></a>
