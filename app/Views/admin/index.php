      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="logo-pro">
          <a href="<?= base_url('/admin-dash') ?>"><img class="main-logo"
              src="<?= base_url('public/admin/img/logo/logo1.png') ?>" alt="" /></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="section-admin container-fluid pl-0">
  <div class="row admin text-center">
    <div class="col-md-12">
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-xl-5 pb-xl-5">
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-xl-5 pb-xl-5" style="margin-bottom: 1px">
          <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
        <div class="product-sales-chart">
          ...
          <ul class="list-inline cus-product-sl-rp">
            <li>
              <h5>
                <i class="fa fa-circle" style="color: #24caa1"></i>Bags
              </h5>
            </li>
            <li>
              <h5>
                <i class="fa fa-circle" style="color: #00b5c2"></i>Shoes
              </h5>
            </li>
            <li>
              <h5>
                <i class="fa fa-circle" style="color: #ff7f5a"></i>Jewelery
              </h5>
            </li>
          </ul>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="white-box tranffic-als-inner">
          <h3 class="box-title">
            <small class="pull-right m-t-10 text-success"><i class="fa fa-sort-asc"></i> 18% last month</small>
            Site Traffic
          </h3>
          <div class="stats-row">
            <div class="stat-item">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="white-box tranffic-als-inner res-mg-t-30">
          <h3 class="box-title">
            <small class="pull-right m-t-10 text-danger"><i class="fa fa-sort-desc"></i> 18% last month</small>Site
            Traffic
          </h3>
          <div class="stats-row">
            <div class="stat-item">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="white-box tranffic-als-inner res-mg-t-30">
          <h3 class="box-title">
            <small class="pull-right m-t-10 text-success"><i class="fa fa-sort-asc"></i> 18% last month</small>Site
            Traffic
          </h3>
          <div class="stats-row">
            <div class="stat-item">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
        <div class="product-sales-chart">
          ...
          <ul class="list-inline cus-product-sl-rp">
            ...
            <li>
              <h5>
                <i class="fa fa-circle" style="color: #888"></i>Shoes
              </h5>
            </li>
            <li>
              <h5>
...
<div class="calender-area mg-tb-30">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <div class="">
          <div><img src="<?= base_url('public/admin/img/logo/elista-2.jpg') ?>" alt=""></div>
        </div>
      </div>
    </div>
  </div>
