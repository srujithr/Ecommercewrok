                ...
                <div class="uk-section-large uk-container">
                    <div class="uk-grid" data-uk-grid>
                        <div class="uk-width-3-4@m">
                            ...
                            <?php foreach ($salwarProducts as $productall) : ?>
                            <div class="product-card product-card--2">
                                <div class="product-card__box">
                                    <div class="product-card__media"><img class="product-card__img" src="<?= base_url('public/uploads/product_images/' . $productall['image']) ?>" alt="V-Bath Saltish" />
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="<?= base_url('public/uploads/product_images/' . $productall['image']) ?>"><?= $productall['product_name'] ?></a><span></span></div>
                                        <div class="product-card__price"><?= $productall['price'] ?></div>
