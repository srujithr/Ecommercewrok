<?php include 'includes/header.php'; ?>
        <main class="page-main">
            <div class="section-hero">
                <div class="section-hero__bg"><img src="<?= base_url('public/website/img/contacts-hero.jpg')?>" alt="home-hero"></div>
                        ...
                        <div>
                            <div class="contacts-info" data-uk-scrollspy="target: &gt; *; cls: uk-animation-slide-bottom-small; delay: 500">
                                ...
                                <div class="contacts-info__item">
                                    <div class="contacts-info__title"></div>
                                    <div class="contacts-info__content"> </div>
                                </div>
                                <div class="contacts-info__item">
                                    <div class="contacts-info__title">Contact</div>
                                    <div class="contacts-info__content">
                                    <a href="tel:+12814005971">T: (+1) 281-400-5971</a><a href="mailto:products@viasun.com">E: products@viasun.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
