<?php include 'includes/header.php';?>
        <main class="page-main">
            <div class="section-hero">
                <div class="section-hero__bg"><img src="<?= base_url('public/website/img/bage banner.jpg')?>" alt="home-hero"></div>
                                ...
                                <div>
                                    <div class="product-card product-card--2">
                                        <div class="product-card__box">
                                            <div class="product-card__media"> <img class="product-card__img" src="<?= base_url('public/website/img/bage3.webp')?>" alt="Skinny Lotion" />
                                            ...
                                            <div class="product-card__info">
                                                <div class="product-card__title"> <a href="<?= base_url('public/website/img/bage3.webp')?>">Skinny Lotion</a><span>Skin Care</span></div>
                            ...
                            <aside class="sidebar">
                                ...
                                <div class="widjet widjet-category">
                                    ...
                                    <ul class="list-category">
                                        ...
                                        <li> <a href="04_blog-main.html"><span>Jewallary</span><span>(67)</span></a></li>
