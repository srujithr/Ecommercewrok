<?php include 'includes/header.php'; ?>
        ...
        <main class="page-main">
            <div class="section-hero">
                <div class="section-hero__bg"><img src="<?= base_url('public/website/img/homefurbanner1.png')?>" alt="home-hero"></div>
                ...
                <div class="uk-section-large uk-container">
                    <div class="uk-grid" data-uk-grid>
                        <div class="uk-width-3-4@m">
                            ...
                            <?php foreach ($furnishingProducts as $product): ?>
                                        ...
                                        <div class="product-card__box">
                                            ...
                                            <div class="product-card__info">
                                                <div class="product-card__title">
                                                    <a href="<?= base_url('public/uploads/product_images/' . $product['image']) ?>"><?= $product['product_name'] ?></a>
                                                    <!-- Add product description if needed -->
