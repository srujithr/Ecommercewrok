...
class AdminController extends BaseController
{
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (!$this->validate($rules, $errors)) {
                ...
                if ($admin && password_verify($this->request->getVar('password'), $admin['password'])) {
                    ...
                    return redirect()->to(base_url('admin-dash'));
                } else {
    ...
    public function registerPage()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (!$this->validate($rules)) {
                ...
                return redirect()->to(base_url('admin-awa/signin'));
            }
        }
    ...
    public function change_password()
    {
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->validate($validationRules, $validationMessages)) {
                ...
                if ($admin && password_verify($this->request->getPost('old-password'), $admin['password'])) {
                    ...
                    if ($updated) {
                        return redirect()->to(base_url('admin-change-password'))->with('success', 'Password updated successfully!');
                    } else {
        ...
        return view('admin/change-password', ['validation' => $this->validator]);
    }
